...
if ARGV.length < 5
  ...
  cmd = "perf stat ./example_minisat/necessary/simp/minisat #{input_file} #{paramstring}"

  # Create a temporary file for capturing output.
  tmp_file = "example_minisat/minisat_output#{rand}.txt"

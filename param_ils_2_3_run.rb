...
# =========================================
def haveToStop()
	#print that i am checking if i have to stop and the time plus the tunertimeout
	
	puts("Total CPU Time #{$total_cputime.to_s},  timeout #{@tunerTimeout.to_s}")
	@out.puts("Total CPU Time #{$total_cputime.to_s},  timeout #{@tunerTimeout.to_s}")
	@out.flush 
	output("Total CPU Time #{$total_cputime.to_s},  timeout #{@tunerTimeout.to_s}")

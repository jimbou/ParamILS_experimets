...
if ARGV.length < 5
  ...
  #print the params
  STDERR.puts "\nparams: #{paramstring}\n\n"
  cmd = "perf stat -e branches java -cp /home/jim/magpie/examples/weka/necessary/build/classes/ weka.classifiers.trees.RandomTree -t  #{input_file} #{paramstring}"
